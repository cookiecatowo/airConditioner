...
- [ ] **照片分類**: 上傳工作場所照片時可選分類 —— 內機 / 外機 / 室內管槽 / 室外管槽 / 配管 / 自行輸入。
- [ ] **收款管理**: 報價單加入收款項目，記錄支付方式與金額，方便對帳。
- [ ] **報表下載格式**: 同時支援下載 Word 與 PDF 格式。
- [x] ~~**顧客管理**: 列表、編輯、合併重複顧客、關聯報價單~~ ← 已完成 (2026-09-14)
- [x] ~~**工作場所照片**: 每張訂單可上傳現場照片並加註說明~~ ← 已完成 (2026-09-14)
